...
public class ReactRectangleSide : Shape
{
    public int material;
    ...
    public ReactRectangleSide(Vector3 LeftDown, Vector3 RightDown, Vector3 LeftUp, Vector3 RightUp, int material, bool backward = false)
    {
